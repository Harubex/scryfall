...
/**
 * The faces of this card, if more than one face is present.
 * Also contains seperate card parts for cards that have several parts (e.g. Flip cards, Aftermath cards).
 */
export interface ScryfallCardFace extends ScryfallObject {
    /**
     * The type descriptor for this object - will always equal "card_face".
     */
    object: "card_face";
    /**
    ...
    printed_text?: string;
    /**
     * The mana cost for this card face.
     * This value will be any empty string "" if the cost is absent or not on this face

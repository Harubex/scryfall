import ScryfallCardFace from "../Cards/ScryfallCardFace";
import ScryfallLayout from "../types/ScryfallLayout";
import ScryfallImages from "../types/ScryfallImages";
...
export interface ScryfallCard extends ScryfallObject {
    ...
    /**
     * The type descriptor for this object - will always equal "card".
     */
    object: "card";
    /**
    ...
    prices: {
        ...
        usd?: string,
        /**
         * The current price of the foil version of this card, in USD. Does not exist for digital-only cards, or cards unavailable in foil.
         */
        usd_foil?: string
        /**
...
/**
 * The various legality options that are used.
 */
export type ScryfallLegality = "legal" | "not_legal" | "banned" | "restricted";
